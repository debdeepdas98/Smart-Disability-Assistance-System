...
#speak function for converting text to speach
def speak(audio):
    engine.say(audio)
    engine.runAndWait()
# load YOLO algo
net = cv2.dnn.readNet("C:/Users/Rohit/PycharmProjects/test/yolov3.weights","C:/Users/Rohit/PycharmProjects/test/yolov3.cfg") # read pre-trained model and config file
classes = []

# list create of coco names
with open("C:/Users/Rohit/PycharmProjects/test/coco.names", "r") as f:
